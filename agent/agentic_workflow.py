...
# # from tools.landmark_recognition_tool import LandmarkRecognitionTool
...
#         # self.landmark_recognition_tool = LandmarkRecognitionTool()
...
class GraphBuilder():
    def __init__(self, model_provider: str = "groq"):
        ...
        self.tools = (
            ...
            self.calculator_tool.calculator_tool_list +
            self.currency_converter_tool.currency_converter_tool_list +
            self.landmark_recognition_tool.landmark_recognition_tool_list
        )
